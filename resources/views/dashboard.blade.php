        ...
        <div class="row">
            <div class="col-md-12">
                <div>
                    ...
                    <h5 class="text-center"><a href="https://santrikoding.com">koding</a></h5>
                    <hr>
                </div>
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <a href="{{ route('products.create') }}" class="btn btn-md btn-success mb-3">ADD PEGAWAI</a>
